...
@NamedQueries({
        ...
        @NamedQuery(name = "FriendShip.findAllRequest", query = "from FriendShip where friend =:friend order by created asc"),
})
public class FriendShip {
    ...
    public FriendShip(User user, User friend, FriendShipStatus status, Date created) {
        this.user = user;
        this.friend = friend;
        this.status = status;
